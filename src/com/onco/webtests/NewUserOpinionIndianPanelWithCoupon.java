...
public class NewUserOpinionIndianPanelWithCoupon extends BaseClass {
	...
	@Test(priority = 2)
	public void newUserOpinionIndiaPanal(String name, String email, String phone, String otp, String patientname,
			String INDcoupon) throws Exception {
