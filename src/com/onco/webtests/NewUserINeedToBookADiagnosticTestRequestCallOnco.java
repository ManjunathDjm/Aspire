...
public class NewUserINeedToBookADiagnosticTestRequestCallOnco extends BaseClass {
	...
	@Test(priority=4,description = "New user | I need to book a diagnostic test. TC_ID=C2581")
	...
	if (actualTilte.contains("Thank you!")) {
		...
		NewUserINeedToBookADiagnosticTestRequestCallOnco.addResultForTestCase("2581", TEST_CASE_PASSED_STATUS, "");
	} else {
		NewUserINeedToBookADiagnosticTestRequestCallOnco.addResultForTestCase("2581", TEST_CASE_FAILED_STATUS, "");
	}
}
